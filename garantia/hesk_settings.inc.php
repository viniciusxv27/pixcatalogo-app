...
// --> General settings
$hesk_settings['site_title']='Urba-Brosol';
$hesk_settings['site_url']='https://www.urba-brosol.com.br';
$hesk_settings['hesk_title']='My help desk';
$hesk_settings['hesk_url']='https://www.urba-brosol.com.br/garantia';
$hesk_settings['webmaster_mail']='schirmacristiano@gmail.com';
...
$hesk_settings['db_name']='pixcatalogo_app';
$hesk_settings['db_user']='pixcatalogo';
$hesk_settings['db_pass']='@Hg356x00@';
$hesk_settings['db_pfix']='help_';
...
$hesk_settings['secimg_sum']='ESGH167BMH';
...
$hesk_settings['url_key']='Ym7tm9FCVmF79p.TeJqWeGP';
...
'max_number' => 2,
'max_size' => 2097152,
'allowed_types' => array('.gif','.jpg','.png','.zip','.rar','.csv','.doc','.docx','.xls','.xlsx','.txt','.pdf','.wmv')
);
...
// --> Email sending
$hesk_settings['noreply_mail']='schirmacristiano@gmail.com';
